...
class Gamepad:
    ...
    def __init__(self, devices):
        ...
        self._report1 = bytearray(2)
        self._report2 = bytearray(4)

        # Remember the last report as well, so we can avoid sending
        # duplicate reports.
        self._last_report1 = bytearray(2)
        self._last_report2 = bytearray(4)
    ...
    def _send1(self, always=False):
        ...
        if always or self._last_report1 != self._report1:
            self._gamepad_device.send_report(self._report1, 2)
    ...
    def _send2(self, always=False):
        ...
        if always or self._last_report2 != self._report2:
            self._gamepad_device.send_report(self._report2, 1)
            # Remember what we sent, without allocating new storage.
